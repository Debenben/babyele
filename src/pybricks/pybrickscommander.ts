...
export class PybricksCommander extends BluetoothHciSocket implements CommanderAbstraction {
  ...
  constructor(dog: SensorAbstraction) {
    ...
    this.on('data', function(data) {
      ...
      if(id == 5) this.dog.notifyDogAcceleration([data.readInt16LE(21), data.readInt16LE(23), data.readInt16LE(25)]);
	...
	topAcceleration[id - 1] = [data.readInt16LE(21), data.readInt16LE(23), data.readInt16LE(25)];
        motorAngles[id - 1][2] = 10*data.readInt16LE(27);
	bottomAcceleration[id - 1] = [data.readInt16LE(29), data.readInt16LE(31), data.readInt16LE(33)];
